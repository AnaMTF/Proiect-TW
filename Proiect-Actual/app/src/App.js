...
import CreateBT from './pagini/createBT';
...
const App = () => {
  return (
    ...
    /* //   <div>
    //     <Link to="/">Home</Link>
    //     <Link to="/createBT">CreateBT</Link>
    //   </div>
    //   <Switch>
    //     <Route path="/" exact><Home /></Route>
    //     <Route path="/createBT" exact><CreateBT /></Route>
    //   </Switch> */
    <div className="App">
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col" id="grad1" style={{"border": "0.2px solid #560bad"}}>
                ...
                <br/><br/>
                {/* <Link to="/createBT"> */}
                  <button class="btn btn-primary m-2" id="createBugTester" onclick="createBugTester()">Create BugTester account</button>
                {/* </Link> */}
                <br/><br/>
