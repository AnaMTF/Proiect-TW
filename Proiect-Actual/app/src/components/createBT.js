    ...
    const  CreateBT = () => {
        return  (
            <div>
                <head>
                    <title></title>
                    <link href="createBT.css" rel="stylesheet" type="text/css" />
                ...
                <body id="grad">
                    <div class="container">
                    <br/><br/><br/><br/>
                    <label id="titlu" style={{"font-weight":"bold"}}>Create Bug Tester account</label>
                    <br/><br/>
                    <br />
                    <div class="row">
                        ...
                        <br/>
                            ...
                            <input type="password"/>
                            <br/><br/>
                            <button class="btn btn-primary m-3" id="createBugTester" onclick="create()">Create account</button>
                            <br/>
                        </div>
                    </div>
                    </div>
